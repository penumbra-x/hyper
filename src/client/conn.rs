...
impl Builder {
    ...
    #[cfg(feature = "http2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "http2")))]
    pub fn http2_settings_order(&mut self, order: Option<[h2::frame::SettingsOrder; 8]>) -> &mut Self {
    ...
    #[cfg(feature = "http2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "http2")))]
    pub fn http2_initial_stream_id(&mut self, stream_id: Option<u32>) -> &mut Self {
    ...
    #[cfg(feature = "http2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "http2")))]
    pub fn http2_unknown_setting8(&mut self, sz: impl Into<Option<bool>>) -> &mut Self {
        self.h2_builder.unknown_setting8 = sz.into();
        self
    }
    ...
    #[cfg(feature = "http2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "http2")))]
    pub fn http2_unknown_setting9(&mut self, sz: impl Into<Option<bool>>) -> &mut Self {
        self.h2_builder.unknown_setting9 = sz.into();
        self
    }
